...
public class Example {
    ...
    public void setUp() {
        ...
        Configuration1 configuration11= new Configuration1();
    ...
    public void shouldBuildInjectDependencies() {
        ...
        System.out.println(hasADependency.getDependency2());
        assertSame(hasADependency.getDependency(), container.getComponent(B.class));
        assertSame(hasADependency.getDependency1(), container.getComponent(A.class));
        //System.out.println(hasADependency.getDependency2());
    }
}
